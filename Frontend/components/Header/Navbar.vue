<template>
  <header
    class="flex flex-wrap  md:justify-start md:flex-nowrap z-50 w-full bg-white/80 backdrop-blur-md fixed top-0 left-0 right-0 border-b border-gray-200 dark:bg-neutral-800/80 dark:border-neutral-700">
    <nav
      ...
      <div class="flex justify-between items-center gap-x-1">
        <NuxtLink class="flex-none font-semibold text-xl text-black focus:outline-hidden focus:opacity-80 dark:text-white"
          to="/" aria-label="Квартиры 4.0">Недвижимость 4.0</NuxtLink>
        <button type="button"
        ...
        <div
          ...
          <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
            ...
            <div class=" flex flex-wrap items-center gap-x-1.5">
              ...
              <NuxtLink class="py-2 px-2.5 inline-flex items-center font-medium text-sm rounded-lg bg-gray-700 text-white hover:bg-gray-800 focus:outline-hidden focus:bg-gray-700 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-500 dark:hover:bg-gray-600 dark:focus:bg-gray-600"
                to="/auth/login">
                Авторизоваться
            </NuxtLink>
            </div>
